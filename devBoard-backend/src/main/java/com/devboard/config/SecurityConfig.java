...
public class SecurityConfig {
    ...
    /**
     * Bean explícito (não {@code @Component}) para não ser também registrado pelo Spring
     * Boot como filtro de servlet global — só deve rodar dentro da cadeia do Spring Security.
     */
    @Bean
