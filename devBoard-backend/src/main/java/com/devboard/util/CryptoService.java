...
/**
 * AES-GCM para dados sensíveis em repouso (ex.: token GitHub). A chave vem de
 * {@code app.encryption.key} — 32 bytes, informados em Base64.
 */
@Component
public class CryptoService {
    ...
    public String decrypt(String encoded) {
        try {
            ...
            throw new IllegalStateException("Falha ao decriptografar valor", ex);
        }
    }
}
